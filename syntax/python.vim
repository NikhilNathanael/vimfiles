...
syn match 	pythonUDVariable	"\v%(\d\a*)@<!\h\w*"
hi def link pythonUDVariable 	UDVariable

" User defined functions
syn match	pythonUDFunction	"\v%(def\s*)@<=\h\w*"
hi def link pythonUDFunction		UDFunction
